...
#
# Here is a short main for a target named test:
#    
...
#=============================================================================#
#
#        name         - The name of the library main        [REQUIRED]
...
#        AFLAGS       - Avrdude flags for target
#
# Creates a main from the specified library.
#
#
#=============================================================================#
# print_board_list()
...
#
#  A good main of a Hardware Platform is in the Arduino SDK:
#
...
function(GENERATE_ARDUINO_EXAMPLE INPUT_NAME)
    ...
    if(NOT ALL_SRCS)
        message(FATAL_ERROR "Missing sources for main, aborting!")
    endif()
...
#  For main, if we have a include "#include <LibraryName.h>" then the following
...
#
# For main, the following settings:
#
...
# all settings (for a main see print_board_settings() function).
#
#=============================================================================#
...
#
# Creates a Arduino main from a the specified library.
#=============================================================================#
function(SETUP_ARDUINO_EXAMPLE TARGET_NAME LIBRARY_NAME EXAMPLE_NAME OUTPUT_VAR)
    ...
    if(EXAMPLE_SKETCH_PATH)
        ...
        message(FATAL_ERROR "Could not find main ${EXAMPLE_NAME} from library ${LIBRARY_NAME}")
    endif()
endfunction()
