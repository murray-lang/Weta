...
baseCodes.initData =
    [
        ...
        { asm: "tx", getCode: function ()
            {
                return [19];
            }
        },
        { asm: "rx", getCode: function ()
            {
                return [20];
            }
        },
        { asm: "newrx", getCode: function ()
            {
                return [21];
            }
        },
        ...
        { asm: "i2cwrite", getCode: function ()
            {
                return [93];
            }
        },
        { asm: "i2cread", getCode: function ()
            {
                return [94];
            }
        },
        ...
        { asm: "enter", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "leave", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        ...
        { asm: "txn", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "rxn", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "newrxn", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        ...
        { asm: "forward", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "backward", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "left", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "right", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "penup", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "pendown", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        ...
        { asm: "encode", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        { asm: "decode", getCode: function (types)
            {
                return types.getNextCode();
            }
        },
        ...
        { asm: "comm", getCode: function (types)
            {
                return [251];
            }
        },
        { asm: "thread", getCode: function (types)
            {
                return [252];
            }
        },
        { asm: "io", getCode: function (types)
            {
                return [253];
            }
        },
...
//--------------
        ...
        { asm: "btx", getCode: function (types)
        {
            return types.concatCodes("withint8", "tx");
        }
        },
        { asm: "ubtx", getCode: function (types)
        {
            return types.concatCodes("withuint8", "tx");
        }
        },
        { asm: "stx", getCode: function (types)
        {
            return types.concatCodes("withint16", "tx");
        }
        },
        { asm: "ustx", getCode: function (types)
        {
            return types.concatCodes("withuint16", "tx");
        }
        },
        { asm: "itx", getCode: function (types)
        {
            return types.concatCodes("withint32", "tx");
        }
        },
        { asm: "uitx", getCode: function (types)
        {
            return types.concatCodes("withuint32", "tx");
        }
        },
        { asm: "ftx", getCode: function (types)
        {
            return types.concatCodes("withfloat", "tx");
        }
        },
        { asm: "dtx", getCode: function (types)
        {
            return types.concatCodes("withdouble", "tx");
        }
        },
        { asm: "qtx", getCode: function (types)
        {
            return types.concatCodes("withbool", "tx");
        }
        },
        { asm: "strtx", getCode: function (types)
        {
            return types.concatCodes("withstring", "tx");
        }
        },
        { asm: "brx", getCode: function (types)
        {
            return types.concatCodes("withint8", "rx");
        }
        },
        { asm: "ubrx", getCode: function (types)
        {
            return types.concatCodes("withuint8", "rx");
        }
        },
        { asm: "srx", getCode: function (types)
        {
            return types.concatCodes("withint16", "rx");
        }
        },
        { asm: "usrx", getCode: function (types)
        {
            return types.concatCodes("withuint16", "rx");
        }
        },
        { asm: "irx", getCode: function (types)
        {
            return types.concatCodes("withint32", "rx");
        }
        },
        { asm: "uirx", getCode: function (types)
        {
            return types.concatCodes("withuint32", "rx");
        }
        },
        { asm: "frx", getCode: function (types)
        {
            return types.concatCodes("withfloat", "rx");
        }
        },
        { asm: "drx", getCode: function (types)
        {
            return types.concatCodes("withdouble", "rx");
        }
        },
        { asm: "qrx", getCode: function (types)
        {
            return types.concatCodes("withbool", "rx");
        }
        },
