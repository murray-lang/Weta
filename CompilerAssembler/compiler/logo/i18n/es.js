var es = {
	"usage: BabuinoLogo.js <logo file in> <basm file out>": "uso: WetaLogo.js <logo archivo en> <wasm archivo salida>",
	...
	"Writing basm to file %s": 								"Escribir wasm para presentar %s",
	"Error writing basm file %s: %s":						"Error al escribir el archivo wasm %s: %s",
